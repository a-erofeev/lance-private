...
impl FileFragment {
    ...
    #[pyo3(signature=(reader, left_on, right_on, strategy="auto", max_hash_rows=None, max_hash_bytes=None, external_memory_pool_bytes=None, max_temp_directory_bytes=None))]
    fn update_columns(
        &mut self,
        reader: PyArrowType<ArrowArrayStreamReader>,
        left_on: String,
        ...
        Ok((PyLance(result.fragment), result.fields_modified))
    }
